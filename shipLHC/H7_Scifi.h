...
class H7_Scifi : public FairDetector
{
public:
    H7_Scifi(const char* name, Bool_t Active, const char* Title = "H7_Scifi");
    H7_Scifi();
    virtual ~H7_Scifi();
     ...
     */
    H7_ScifiPoint* AddHit(Int_t trackID, Int_t detID,
    ...
    H7_Scifi(const H7_Scifi&);
    H7_Scifi& operator=(const H7_Scifi&);
...
private:
    ...
    TClonesArray*  fH7_ScifiPointCollection;
