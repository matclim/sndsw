#ifndef H7_SCIFIPOINT_H
#define H7_SCIFIPOINT_H 1
...
class H7_ScifiPoint : public FairMCPoint
{
  ...
  public:
     ...
     **/
    H7_ScifiPoint(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom,
...
*/
  ...
  private:
    /** Copy constructor **/
    Int_t fPdgCode;
    H7_ScifiPoint(const H7_ScifiPoint& point);
    H7_ScifiPoint operator=(const H7_ScifiPoint& point);

    ClassDef(H7_ScifiPoint,2)
